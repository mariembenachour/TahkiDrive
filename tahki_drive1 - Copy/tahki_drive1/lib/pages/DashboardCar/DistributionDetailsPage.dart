...
class _DistributionDetailsPageState extends State<DistributionDetailsPage>
                        ...
                        child: Column(
                          ...
                          children: [
                            if (lastDistribution != null)
                              _buildLastDistributionCard(lastDistribution!),
  ...
  Widget _buildLastDistributionCard(Map<String, dynamic> data) {
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          // STARS FIX (ne casse pas le layout)
                          Row(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isFirst
              ? Border.all(
              color: const Color(0xFF7226FF).withOpacity(0.3), width: 1.5)
              : null,
          boxShadow: [
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        _popupSection("Maintenance", [
                          ...
                          _popupRow(Icons.notes, "Description", data["description"] ?? "—"),
                        ]),
