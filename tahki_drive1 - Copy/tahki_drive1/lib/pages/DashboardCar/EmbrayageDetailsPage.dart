...
class EmbrayageDetailsPage extends StatefulWidget {
  const EmbrayageDetailsPage({super.key});
...
class _EmbrayageDetailsPageState extends State<EmbrayageDetailsPage>
  ...
  Map<String, dynamic>? lastEmbrayage;
  ...
  Future<void> _loadEmbrayage() async {
    try {
      final data = await DetailPannesService.fetchEmbrayage();
      setState(() {
        lastEmbrayage = data?["last"];
                      ...
                      child: Row(
                        children: [
                          ...
                          const Column(
                            ...
                            children: [
                              Text("Embrayage", style: TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)),
                    ...
                    child: FadeTransition(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if (lastEmbrayage != null) _buildLastEmbrayageCard(lastEmbrayage!),
  ...
  Widget _buildLastEmbrayageCard(Map<String, dynamic> data) {
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Container(padding: const EdgeInsets.all(14), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.settings_input_component, color: Colors.white, size: 32)),
                const SizedBox(width: 15),
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 15),
                _buildInfoTile(Icons.notes, "Description", data["description"] ?? "—", Colors.deepPurple),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.settings_input_component, color: Colors.white, size: 18),
            ),
            const SizedBox(width: 15),
            Expanded(
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(_formatDate(data["date_operation"]), style: TextStyle(color: Colors.grey.shade500, fontSize: 12)),
                    ],
                  ),
                  const SizedBox(height: 5),
                  Text("Coût: ${data["cost"] ?? "—"} TND  •  ${data["actual_repair_time"] ?? "—"} h", style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                  const SizedBox(height: 5),
                  Row(
                    children: [
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.settings_input_component, color: Colors.white, size: 24)),
