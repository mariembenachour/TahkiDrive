...
import 'package:tahki_drive1/pages/DashboardCar/historique_events.dart';
...
// Ajoute cette fonction après _loadOdo ou avant dispose
  Future<void> _getDriverIdAndNavigate() async {
    // Récupère l'ID du driver depuis AuthService
    ...
    if (driverId != null) {
      if (mounted) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => HistoriqueEventsPage(driverId: driverId),
          ),
        );
      }
    } else {
      // Fallback si pas d'ID (utilise 6 par défaut)
      if (mounted) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => HistoriqueEventsPage(driverId: 6),
          ),
        );
      }
    }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildDialogRow(
                            "Date",
                            lastService?['date_operation'] != null
                                ? lastService!['date_operation'].toString().split('T')[0]
                                : '-',
                          ),
                          _buildDialogRow(
                            "Main d'œuvre",
                            "${lastService?['labor_cost'] ?? '-'} DT",
                          ),
                          _buildDialogRow(
                            "Fin réparation", // Dans ton JSON c'est une date de fin, on affiche le jour
                            lastService?['actual_repair_time'] != null
                                ? lastService!['actual_repair_time'].toString().split('T')[0]
                                : '-',
                          ),
                          _buildDialogRow(
                            "Garage",
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildDialogRow(
                            "Date",
                            lastOil?['date_operation'] != null
                                ? lastOil!['date_operation'].toString().split('T')[0]
                                : '-',
                          ),
                          _buildDialogRow(
                            "Main d'œuvre",
                            "${lastOil?['labor_cost'] ?? '-'} DT",
                          ),
                          _buildDialogRow(
                            "Fin réparation", // Affichage de la date/heure de fin
                            lastOil?['actual_repair_time'] != null
                                ? lastOil!['actual_repair_time'].toString().replaceFirst('T', ' à ')
                                : '-',
                          ),
                          _buildDialogRow(
                            "Garage",
...
// 2. On affiche les lignes
                          ...
                          _buildDialogRow(
                            "Date",
                            lastBrake?['date_operation'] != null
                                ? lastBrake!['date_operation'].toString().split('T')[0]
                                : '-',
                          ),
                          _buildDialogRow(
                            "Main d'œuvre",
                            "${lastBrake?['labor_cost'] ?? '-'} DT",
                          ),
                          _buildDialogRow(
                            "Fin réparation",
                            lastBrake?['actual_repair_time'] != null
                                ? lastBrake!['actual_repair_time'].toString().replaceFirst('T', ' à ')
                                : '-',
                          ),
                          _buildDialogRow(
                            "Garage",
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildDialogRow(
                            "Date",
                            lastEmbrayage?['date_operation'] != null
                                ? lastEmbrayage!['date_operation'].toString().split('T')[0]
                                : '-',
                          ),
                          _buildDialogRow(
                            "Main d'œuvre",
                            "${lastEmbrayage?['labor_cost'] ?? '-'} DT",
                          ),
                          _buildDialogRow(
                            "Fin réparation",
                            lastEmbrayage?['actual_repair_time'] != null
                                ? lastEmbrayage!['actual_repair_time'].toString().split('T')[0]
                                : '-',
                          ),
                          _buildDialogRow(
                            "Garage",
