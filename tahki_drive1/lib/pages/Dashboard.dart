    ...
    showGeneralDialog(
      ...
      transitionBuilder: (context, anim1, anim2, child) {
        return ScaleTransition(
          scale: CurvedAnimation(parent: anim1, curve: Curves.bounceOut),          child: FadeTransition(
            opacity: anim1,
            child: AlertDialog(
            ...
            child: Padding(
              ...
              GestureDetector(
                onTap: () {
                  ...
                  // ================= CARROUSEL GLOBAL : VOITURE + BATTERIE + HUILE + TEMP =================
                  SizedBox(
                    height: 280,
                    child: SingleChildScrollView(
                      scrollDirection: Axis.horizontal,
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                PageRouteBuilder(
                                  transitionDuration: const Duration(milliseconds: 800), // Transition fluide
                            ...
                            child: Hero(
                              tag: 'car_top_view', // Identifiant unique pour l'animation
                              child: Container(
                                width: 210,
                                decoration: BoxDecoration(
                                ...
                                child: Material(
                                  color: Colors.transparent, // Nécessaire pour éviter les bugs visuels du Hero
                                  child: Stack(
                                    alignment: Alignment.center,
                                    children: [
                                      // Image de la voiture vue de dessus
                                      Align(
  ...
  Widget _miniPsi(String value) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.deepPurple.withOpacity(0.5), blurRadius: 10, offset: const Offset(0, 4)),
        ],
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget _buildStatusCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.deepPurple.withOpacity(isDark ? 0.4 : 0.25), blurRadius: 20, offset: const Offset(0, 10)),
        ],
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
...
class MapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    smallRoad.quadraticBezierTo(
        size.width * 0.7, size.height * 0.5, size.width * 0.3, size.height);
