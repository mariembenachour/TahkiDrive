                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("Embrayage", style: TextStyle(color: Colors.white, fontSize: 26.sp, fontWeight: FontWeight.bold)),
                    ...
                    child: FadeTransition(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if (lastEmbrayage != null) _buildLastCard(lastEmbrayage!, isDark, cardColor, textColor, subtitleColor),
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Container(padding: EdgeInsets.all(10.w), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.settings_input_component, color: Colors.white, size: 24)),
                    SizedBox(width: 12.w),
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(data["maintenance_type"] ?? "—", style: TextStyle(color: Colors.white, fontSize: 18.sp, fontWeight: FontWeight.bold)),
