                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("Tire", style: TextStyle(color: Colors.white, fontSize: 26.sp, fontWeight: FontWeight.bold)),
                    ...
                    child: FadeTransition(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if (lastTire != null) _buildLastCard(lastTire!, isDark, cardColor, textColor, subtitleColor),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle),
                  child: const Icon(Icons.tire_repair, color: Colors.white, size: 32),
                ),
                SizedBox(width: 15.w),
                Expanded(
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Container(padding: EdgeInsets.all(10.w), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.tire_repair, color: Colors.white, size: 24)),
                    SizedBox(width: 12.w),
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(data["maintenance_type"] ?? "—", style: TextStyle(color: Colors.white, fontSize: 18.sp, fontWeight: FontWeight.bold)),
