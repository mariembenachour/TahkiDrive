                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("Freins", style: TextStyle(color: Colors.white, fontSize: 26.sp, fontWeight: FontWeight.bold)),
                    ...
                    child: FadeTransition(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if (lastBrake != null) _buildLastCard(lastBrake!, isDark, cardColor, textColor, subtitleColor),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(_formatDate(data["date_reparation"]),
                  ...
                  Row(
                    children: [
                      Icon(Icons.store, size: 13.w, color: subtitleColor?.withOpacity(0.6)),
                      SizedBox(width: 4.w),
                      Text("${data["cost"] ?? "—"} TND",
                          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.sp, color: const Color(0xFF7226FF))),
                    ],
                  ),
                ],
              ),
