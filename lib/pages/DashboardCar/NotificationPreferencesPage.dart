              ...
              Container(
                ...
                child: Row(children: [
                  Icon(Icons.info_outline,
                      size: 16.w, color: Colors.amber.shade700),
                  SizedBox(width: 8.w),
                  Expanded(
              ...
              child: Center(
                  child: SizedBox(
                      ...
                      child: CircularProgressIndicator(
                          strokeWidth: 2.w, color: Color(0xFF7226FF)))),
            ),
        ],
      ),
      body: _loading
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child:  Text('Enregistrer les préférences',
                    style: TextStyle(
    ...
    return ListTile(
      ...
      title: Text(title,
          style: const TextStyle(
              ...
              fontSize: 15)),
      subtitle:
      Text(subtitle, style: TextStyle(fontSize: 12.sp, color: Colors.grey[500])),
      trailing: Transform.scale(
        scale: 0.8,
        child: Switch(
