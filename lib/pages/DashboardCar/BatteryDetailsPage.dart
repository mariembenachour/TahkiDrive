                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("Batteries", style: TextStyle(color: Colors.white, fontSize: 26.sp, fontWeight: FontWeight.bold)),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 15.h),
          Text("Aucune maintenance trouvée".tr(),
              style: TextStyle(color: Colors.white, fontSize: 18.sp, fontWeight: FontWeight.bold)),
          SizedBox(height: 8.h),
          Text("Aucun enregistrement disponible".tr(),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Container(padding: EdgeInsets.all(14.w), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle),
                ...
                Container(
                  ...
                  child: Text("actuelle".tr(), style: TextStyle(color: Colors.white, fontSize: 12.sp, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          ),
          Padding(
            ...
            child: Column(
              children: [
                Row(children: [Expanded(child: _buildInfoTile(Icons.notes, "Description".tr(), data["description"] ?? "—", const Color(0xFF160078), isDark))]),
                SizedBox(height: 15.h),
                Row(children: [Expanded(child: _buildInfoTile(Icons.attach_money, "Coût".tr(), "${data["cost"] ?? "—"} ${'unité TND'.tr()}", Colors.deepPurple, isDark))]),
                SizedBox(height: 15.h),
                Row(children: [Expanded(child: _buildInfoTile(Icons.calendar_today, "Date".tr(), _formatDate(data["date_reparation"]), const Color(0xFF7226FF), isDark))]),
              ],
            ),
          ),
        ],
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text("${data["cost"] ?? "—"} ${'unité TND'.tr()}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.sp, color: Color(0xFF7226FF))),
                    ],
                  ),
                ],
              ),
    ...
    showModalBottomSheet(
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        builder: (context, scrollController) => Container(
          ...
          child: Column(
            children: [
              Container(margin: EdgeInsets.only(top: 12.h, bottom: 8), width: 40.w, height: 4.h, decoration: BoxDecoration(color: subtitleColor?.withOpacity(0.3), borderRadius: BorderRadius.circular(10.r))),
              Container(
                margin: EdgeInsets.fromLTRB(16.w, 0.h, 16.w, 0.h),
                padding: EdgeInsets.all(18.w),
                decoration:  BoxDecoration(gradient: LinearGradient(colors: [Color(0xFF7226FF), Color(0xFF160078)], begin: Alignment.topLeft, end: Alignment.bottomRight), borderRadius: BorderRadius.all(Radius.circular(24.r))),
                child: Row(
                  children: [
                    Container(padding: EdgeInsets.all(10.w), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.battery_charging_full, color: Colors.white, size: 24)),
                    SizedBox(width: 12.w),
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(data["maintenance_type"] ?? "—", style: TextStyle(color: Colors.white, fontSize: 18.sp, fontWeight: FontWeight.bold)),
                      Text(_formatDate(data["date_reparation"]), style: TextStyle(color: Colors.white70, fontSize: 12)),
                    ])),
                    GestureDetector(onTap: () => Navigator.pop(context), child: Container(padding: EdgeInsets.all(8.w), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.close, color: Colors.white, size: 18))),
                  ],
                ),
              ),
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    _popupSection("maintenance".tr(), [
                      _popupRow(Icons.build, "type".tr(), data["maintenance_type"] ?? "—", popupText, subtitleColor),
                      _popupRow(Icons.calendar_month, "date".tr(), _formatDate(data["date_reparation"]), popupText, subtitleColor),
                      _popupRow(Icons.attach_money, "cost".tr(), "${data["cost"] ?? "—"} ${'unit TND'.tr()}", popupText, subtitleColor),
                      _popupRow(Icons.notes, "observation".tr(), data["description"] ?? "—", popupText, subtitleColor),
                    ], popupText),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 7.w),
                                  Text("modifier".tr(), style: TextStyle(color: Color(0xFF7226FF), fontWeight: FontWeight.w700, fontSize: 14)),
                                ],
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 7.w),
                                  Text("supprimer".tr(), style: TextStyle(color: Colors.red, fontWeight: FontWeight.w700, fontSize: 14)),
                                ],
                              ),
                            ),
                          ),
