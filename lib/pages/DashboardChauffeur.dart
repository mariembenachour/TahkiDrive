...
class _DashboardChauffeurState extends State<DashboardChauffeur> with SingleTickerProviderStateMixin {
  ...
  // Widget avec animation d'entrée
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Contenu principal avec décalage vers le bas
          SafeArea(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Stats de fatigue avec barres (comme avant)
                  _animatedEntry(
                    delay: 0.2,
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Container(
                                        ...
                                        child: Icon(Icons.timer, color: bluePrimary, size: 20),
                                      ),
                                  ...
                                  Icon(
                                    _isFatigueCardExpanded ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
                                    color: bluePrimary,
                                  ),
                                ],
                              ),
                  ...
                  // Carte de sécurité avec animation
                  _animatedEntry(
                    delay: 0.3,
                  ...
                  // Activités récentes avec animation
                  _animatedEntry(
                    delay: 0.4,
          ...
          // Icône de notification en haut à droite (MODIFIÉE: bleu transparent)
          Positioned(
              ...
              child: GestureDetector(
                ...
                child: TweenAnimationBuilder(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: bluePrimary.withOpacity(0.2), // Bleu transparent
                      borderRadius: BorderRadius.circular(15),
                      border: Border.all(
                        color: bluePrimary.withOpacity(0.3), // Bordure bleue transparente
                        width: 1.5,
                      ),
                    ),
                    child: Stack(
          ...
          // Menu du bas (réglé) avec animations de clic
          Positioned(
            bottom: 20,
            left: 20,
            right: 20,
  ...
  // Fonction pour les stats en barres (comme avant)
  ...
  Widget _buildSecurityCard() {
    return GestureDetector(
      onTap: () {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Ceinture de sécurité vérifiée", style: GoogleFonts.poppins()),
            backgroundColor: bluePrimary,
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(20),
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.check, color: bluePrimary, size: 20),
                ),
              ],
            ),
          ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 15),
            _buildActivityItem("Trajet Paris", "Il y a 2h", Icons.directions_car),
            _buildActivityItem("Pause déjeuner", "Il y a 5h", Icons.free_breakfast),
  ...
  Widget _buildActivityItem(String title, String time, IconData icon) {
    return GestureDetector(
      onTap: () {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Détails de l'activité", style: GoogleFonts.poppins()),
            backgroundColor: bluePrimary,
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(20),
  ...
  Widget _buildProfileBottomNav() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildNavItem(Icons.grid_view_rounded, "Accueil", 0, true),
          _buildNavItem(Icons.bar_chart_rounded, "Stats", 1, false),
          _buildNavItem(Icons.notifications_none_rounded, "Alertes", 2, false),
          _buildNavItem(Icons.person_outline_rounded, "Profil", 3, false),
        ],
      ),
    );
  }
