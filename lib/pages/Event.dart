              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    // Condition d'affichage avec animation par bloc
                    if (selectedTab == "Category") ...[
                      _luxuryAnimatedEntry(
                        delay: 0.3,
                        child: _buildCategoryHeader("Trajets", Icons.map_rounded),
                      ),
                      _luxuryAnimatedEntry(
                        delay: 0.4,
                        child: _buildEventItem(icon: Icons.route_outlined, title: "Sfax to Tunis", desc: "270 km • 3h 15min", time: "Today", color: Colors.blue),
                      ),
                      const SizedBox(height: 20),
                      _luxuryAnimatedEntry(
                        delay: 0.5,
                        child: _buildCategoryHeader("Entretien", Icons.build_rounded),
                      ),
                      _luxuryAnimatedEntry(
                        delay: 0.6,
                        child: _buildEventItem(icon: Icons.build_circle_outlined, title: "Vidange", desc: "Filtre à huile changé", time: "Yesterday", color: Colors.green),
                      ),
                    ]
                    else ...[
                      _luxuryAnimatedEntry(
                      ...
                      _luxuryAnimatedEntry(
                        delay: 0.4,
                        child: _buildEventItem(icon: Icons.route_outlined, title: "Sfax to Tunis", desc: "Arrivé à destination", time: "14:30", color: Colors.blue),
                      ),
                      const SizedBox(height: 20),
                      _luxuryAnimatedEntry(
                        delay: 0.5,
                        child: _buildSectionTitle("Yesterday"),
                      ),
                      _luxuryAnimatedEntry(
                        delay: 0.6,
                        child: _buildEventItem(icon: Icons.build_circle_outlined, title: "Maintenance", desc: "Checkup complet", time: "10:00", color: Colors.green),
                      ),
                    ],
