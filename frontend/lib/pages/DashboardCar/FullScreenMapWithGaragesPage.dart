                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        _address != null
                            ? Text(_address!, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: textColor))
                            : Text("Chargement...", style: TextStyle(fontSize: 14, color: isDark ? Colors.white54 : Colors.grey)),
                      ],
                    ),
                  ),
                ]),
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(children: [
                        ...
                        Text("10 plus proches", style: TextStyle(fontSize: 10, color: isDark ? Colors.white54 : Colors.black54)),
                      ]),
                      Row(children: [
                        const Icon(Icons.circle, color: Colors.orange, size: 12),
                        const SizedBox(width: 4),
                        Text("Autres garages", style: TextStyle(fontSize: 10, color: isDark ? Colors.white54 : Colors.black54)),
                      ]),
                    ],
                  ),
                ),
