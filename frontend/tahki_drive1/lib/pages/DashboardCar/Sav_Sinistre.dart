...
class SinistrePage extends StatefulWidget {
  ...
  @override
  State<SinistrePage> createState() => _SinistrePageState();
}
...
class _SinistrePageState extends State<SinistrePage>
  ...
  Future<void> _load() async {
    try {
      final accidents = await SavSinistreService.fetchAccidents();
      final pannes = await SavSinistreService.fetchPannes();
...
class _SavCardState extends State<_SavCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final isAccident = s["type"] == "accident";
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  _row(Icons.description, "Description SAV",
                      s["sav_description"]),
