...
class _BatteryDetailsPageState extends State<BatteryDetailsPage>
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (lastBattery != null)
                              _buildLastBatteryCard(lastBattery!),
  ...
  // ============ CARTE DERNIERE BATTERIE ============
  Widget _buildLastBatteryCard(Map<String, dynamic> data) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.deepPurple.withOpacity(0.15),
          ...
          Padding(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Expanded(child: _buildInfoTile(Icons.attach_money, "Coût",
                        "${data["cost"] ?? "—"} TND", const Color(0xFF7226FF))),
                    Expanded(child: _buildInfoTile(Icons.handyman, "Main d'oeuvre",
                        "${data["labor_cost"] ?? "—"} TND", const Color(0xFF160078))),
                  ],
                ),
                const SizedBox(height: 15),
                Row(
                  children: [
                    Expanded(child: _buildInfoTile(Icons.timer, "Durée",
                        "${data["actual_repair_time"] ?? "—"} h", Colors.deepPurple)),
                    Expanded(child: _buildInfoTile(Icons.calendar_today, "Date",
                        _formatDate(data["date_operation"]), Colors.purple)),
                  ],
                ),
                const SizedBox(height: 15),
                _buildInfoTile(Icons.notes, "Observation",
                    data["observation"] ?? "—", Colors.deepPurple),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(color: const Color(0xFF7226FF).withOpacity(0.1)),
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(
                        children: [
                          ...
                          Row(children: List.generate(5, (i) => Icon(
                            i < (garage["rating"] ?? 0).round() ? Icons.star : Icons.star_border,
                      ...
                      Row(children: [
                        Icon(Icons.phone, color: Colors.grey.shade400, size: 14),
                        const SizedBox(width: 5),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.all(18),
                    decoration: const BoxDecoration(
                      gradient: LinearGradient(colors: [Color(0xFF7226FF), Color(0xFF160078)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                    ...
                    child: ListView(
                      ...
                      children: [
                        _popupSection("Maintenance", [
                          _popupRow(Icons.build, "Type", data["maintenance_type"] ?? "—"),  // 👈 direct
