...
import 'package:tahki_drive1/pages/DashboardCar/Event.dart';
...
class _ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadDriver() async {
    try {
      ...
      setState(() { _driver = data; _loading = false; });
    } catch (e) {
                    ...
                    children: [
                      ...
                      _luxuryAnimatedEntry(
                        ...
                        child: _buildMenuContainer([
                          _buildMenuItem(context, Icons.warning_amber_rounded, "Problem History", onTap: () => _navigateTo(context, const AlertsPage())),
                          _buildDivider(),
                          _buildMenuItem(context, Icons.event_note_rounded, "Events", onTap: () => _navigateTo(context, const EventHistoriquePage())),
                          _buildDivider(),
                          ...
                          _buildMenuItem(
                            ...
                            onTap: () => _navigateTo(context, const SinistrePage()),
                          ),
                          _buildDivider(),
                        ]),
                      ),
