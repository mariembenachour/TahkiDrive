                      ...
                      child: Row(
                        children: [
                          ...
                          const Column(
                            ...
                            children: [
                              Text("Batterie", style: TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)),
                    ...
                    child: FadeTransition(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if (lastBattery != null) _buildLastCard(lastBattery!),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Container(padding: const EdgeInsets.all(14), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.battery_charging_full, color: Colors.white, size: 32)),
                const SizedBox(width: 15),
