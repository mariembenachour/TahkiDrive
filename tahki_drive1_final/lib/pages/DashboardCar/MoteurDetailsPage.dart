...
class MoteurDetailsPage extends StatefulWidget {
  const MoteurDetailsPage({super.key});

  @override
  State<MoteurDetailsPage> createState() => _MoteurDetailsPageState();
}

class _MoteurDetailsPageState extends State<MoteurDetailsPage>
  ...
  Future<void> _loadMoteur() async {
    try {
      final data = await DetailPannesService.fetchMoteur();
      setState(() {
        lastMoteur = data?["last"];
                      ...
                      child: Row(
                        children: [
                          ...
                          const Column(
                            ...
                            children: [
                              Text("Moteur", style: TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)),
                    ...
                    child: FadeTransition(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if (lastMoteur != null) _buildLastCard(lastMoteur!),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Container(padding: const EdgeInsets.all(14), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.car_repair, color: Colors.white, size: 32)),
                const SizedBox(width: 15),
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: const Icon(Icons.car_repair, color: Colors.white, size: 24)),
